        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-4 md:px-6">
          <div className="max-w-2xl" style={{ wordBreak: "keep-all" }}>
            ...
            <h1 className="text-[1.4rem] font-bold leading-snug tracking-tight text-white md:text-5xl md:leading-tight">
              ...
              <span className="mt-1 inline-block font-extrabold leading-snug text-[#5c85ff] md:mt-3 md:rounded-lg md:bg-[#1a1aad] md:px-4 md:py-2 md:leading-tight md:text-white">
                학위 하나면 세 곳 다 열립니다
              </span>
            </h1>
